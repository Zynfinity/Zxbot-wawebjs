...
module.exports = {
    ...
    async handler(m, {conn, msgId, hasMedia, type, mimetype, quotedMsg, command,zx, text}){
        ...
        else conn.reply(m, `reply image/sticker dengan caption .${command} <pack|author>`, msgId)
